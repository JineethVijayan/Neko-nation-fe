...
const Interests = () => {
    return (
        ...
        <div className="ps-4 flex overflow-x-auto no-scrollbar gap-10 whitespace-nowrap scroll-smooth">
            ...
            <Link to={'/product/interests/movies'} className="h-72 min-w-72 bg-black text-white flex items-center justify-center text-2xl" style={{backgroundImage:"url('../images/culture1.jpg')",backgroundSize: "cover", backgroundPosition: "center"}}>
            Movies
            </Link>
